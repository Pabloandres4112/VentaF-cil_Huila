...
export function ResetIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <Svg {...props}>
      ...
      />
      <path
        d="M5.5 15a8 8 0 0 0 13.9 2.5M18.5 9A8 8 0 0 0 4.6 6.5"
        stroke="currentColor"
        strokeWidth={1.8}
        strokeLinecap="round"
      />
...
export function EyeOffIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <Svg {...props}>
      <path
        d="M3 3l18 18M10.6 10.6a3 3 0 0 0 4.24 4.24M9.4 5.3A10.9 10.9 0 0 1 12 5c6.5 0 10 7 10 7a13.2 13.2 0 0 1-3.1 3.9M6.2 6.2C4 7.7 2 12 2 12a13.2 13.2 0 0 0 5.6 5.9"
        stroke="currentColor"
        strokeWidth={1.8}
        strokeLinecap="round"
        strokeLinejoin="round"
