...
// más el aviso de vencimiento del plan Pro (PlanRenewalBanner) — ahora vive
// acá (no en layout.tsx) porque necesita la tienda, y layout.tsx pasó a ser
// un Server Component que la trae una sola vez con requireTienda().
...
export function DashboardChrome({ tienda, children }: { tienda: Tienda; children: ReactNode }) {
