    ...
    <>
      ...
      <div className="flex flex-col gap-6 text-sm leading-relaxed text-ink-soft">
        <Section title="1. Objeto del servicio">
          <p>
            Vitrina Digital (&quot;nosotros&quot;) es un servicio que
            permite a comerciantes (&quot;el Comercio&quot;, &quot;tú&quot;) crear un catálogo
            digital de productos y recibir pedidos organizados a través de WhatsApp. Vitrina Digital
        ...
        <Section title="4. Planes y pagos">
          <p>
            Vitrina Digital ofrece distintos planes, incluido uno gratuito con límites de uso (por
        ...
        <Section title="6. Integración con WhatsApp">
          <p>
            Vitrina Digital genera enlaces públicos de WhatsApp (wa.me) para que los pedidos lleguen
            directamente al número de WhatsApp que configures. Vitrina Digital no está afiliado,
        ...
        <Section title="10. Limitación de responsabilidad">
          <p>
            Vitrina Digital se ofrece &quot;tal cual&quot;. No garantizamos que el servicio esté
            libre de interrupciones o errores. Vitrina Digital no es responsable por disputas,
